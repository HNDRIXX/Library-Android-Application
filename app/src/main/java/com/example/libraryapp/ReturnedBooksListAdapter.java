...
public class ReturnedBooksListAdapter extends FirebaseRecyclerAdapter<BookTransaction, ReturnedBooksListAdapter.myViewHolder> {

    private ProgressBar progressBar;

    public ReturnedBooksListAdapter(@NonNull FirebaseRecyclerOptions<BookTransaction> options) {
        super(options);
    }
