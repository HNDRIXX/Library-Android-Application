...
public class IssueBooksAdapter extends FirebaseRecyclerAdapter<BookTransaction, IssueBooksAdapter.myViewHolder> {

    private ProgressBar progressBar;

    public IssueBooksAdapter(@NonNull FirebaseRecyclerOptions<BookTransaction> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder (@NonNull myViewHolder holder, int position, @NonNull BookTransaction bookTransaction) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), IssueBooksClick.class);

                intent.putExtra("key", key);
                intent.putExtra("userUID", bookTransaction.getUserUID());
