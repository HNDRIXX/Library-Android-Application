...
public class ScanBooksAdapter extends FirebaseRecyclerAdapter<SearchModel,ScanBooksAdapter.myViewHolder> {

    private ProgressBar progressBar;

    public ScanBooksAdapter(@NonNull FirebaseRecyclerOptions<SearchModel> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder (@NonNull myViewHolder holder,  int position, @NonNull SearchModel model) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), ScanBooksSuccessClick.class);
